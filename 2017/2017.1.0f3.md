...
*   2D: Introduced 2D Sprite Atlas, a new asset that will supplant the Sprite Packer. With it comes new and improved workflows that gives the developer more control on how to pack sprites and use them at runtime. ![description](https://unity.com/sites/default/files/2017_1_feature_spriteatlas.gif)
*   2D: Sprite Mask. Mask Sprites in world space using the new SpriteMask component. ![description](https://unity.com/sites/default/files/2017_1_feature_spritemask.gif)
...
*   Animation: New GameObjectRecorder in UnityEditor.Experimental.Animations ![description](https://unity.com/sites/default/files/2017_1_feature_experimental_gameobjectrecorder.gif)
...
*   Build Pipeline: The Asset Bundle Browser comes out of beta with Unity 2017.1. This tool enables the user to view and edit the configuration of Asset Bundles for their Unity project. It is intended to replace the current workflow of selecting assets and setting their Asset Bundle manually in the inspector. ![description](https://unity.com/sites/default/files/2017_1_feature_ab_browser.png)
*   Collab: In-Progress. In-Progress allows developers using Unity Collaborate to see who else on their team has made local changes to a Scene or Prefab before those changes have been published. ![description](https://unity.com/sites/default/files/2017_1_feature_collabinprogressprojectbrowser.gif)
*   Editor: Added new [ArcHandle](https://docs.unity3d.com/2017.1/Documentation/ScriptReference/IMGUI.Controls.ArcHandle.html) class in UnityEditor.IMGUI.Controls to interactively edit arcs in the Scene View. ![description](https://unity.com/sites/default/files/2017_1_feature_archandle.gif)
...
*   Graphics: Added Custom Render Texture asset. A Custom Render Texture is a new type of Render Texture that can be easily updated with a shader. It provides a user interface and a scripting framework. ![description](https://unity.com/sites/default/files/2017_1_feature_customrendertexture.gif)
...
*   Particles: Added support for using Sprites in the Particle System, via the Texture Sheet Animation Module ![description](https://unity.com/sites/default/files/2017_1_feature_particle_sprites.gif)
*   Particles: Apply Noise Module data to particles sizes and rotations, and also send the noise data to your shaders via new Custom Vertex Streams. ![description](https://unity.com/sites/default/files/2017_1_feature_particle_noise_1.gif) ![description](https://unity.com/sites/default/files/2017_1_feature_particle_noise_2.gif)
*   Particles: New Donut emission shape. ![description](https://unity.com/sites/default/files/2017_1_feature_particle_donut.gif)
*   Playables: Playable Assets added to Playable API.
*   Playables: Playable Director added to play Playable Assets
*   Playables: Timeline Editor and Runtime API. A tool for sequencing animation, scripts and audio. ![description](https://unity.com/sites/default/files/2017_1_feature_timeline.png)
*   Scripting: Experimental support for new scripting runtime. This includes Mono 4.8 and IL2CPP with support for C# 6 and .NET 4.6 ![description](https://unity.com/sites/default/files/2017_1_feature_scriptingruntimeupgrade.png)
...
*   Collab: Project Browser Filters including 'All Modified', 'All Excluded', 'All Conflicts', 'All In Progress' ![description](https://unity.com/sites/default/files/2017_1_feature_collabprojectbrowserfilters.gif)
*   Collab: Right Click Menu Options in the Project Browser including See Differences, Revert, Conflict Resolution ![description](https://unity.com/sites/default/files/2017_1_feature_collabpublishrevertrightmenu.gif) ![description](https://unity.com/sites/default/files/2017_1_feature_collabconflictresolverightmenu.gif)
...
*   Particles: Align Particles to their velocity direction ![description](https://unity.com/sites/default/files/2017_1_improvement_particles_align_velocity.gif)
*   Particles: Allow Emit over Distance to be used for Local Space systems ![description](https://unity.com/sites/default/files/2017_1_improvement_particles_local_emit_over_distance.gif)
...
*   Particles: Particles can now apply forces to the Colliders they hit ![description](https://unity.com/sites/default/files/2017_1_improvement_particle_forces_1.gif) ![description](https://unity.com/sites/default/files/2017_1_improvement_particle_forces_2.gif)
...
*   Particles: Randomize the spawn positions of particles, with a new option in the Shape Module. ![description](https://unity.com/sites/default/files/2017_1_improvement_randomize_spawn_positions.gif)
...
*   Area: Description [(FogBugz ID)](https://unity.com/Issuetracker)
