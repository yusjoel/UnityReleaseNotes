...
This release of Unity primarily contains fixes to Unity 3.4. For more information about recent features, see the [Unity 3.4 Release Notes](https://unity.com/unity/whats-new/unity-3.4).
