...
![](https://unity.com/profiles/unity3d/themes/unity/images/assets/elements/blank-1080.gif)
...
*   Editor: Users can now disable domain reload and Scene reload when entering Play mode. This can speed up iteration in the editor. ![description](https://unity.com/sites/default/files/2019-3-feature-enterplaymodeoptionsgraph.jpg)
    
*   Editor: Users can now set custom UI scaling on windows across the Editor.
    
*   GI: Added AMD Radeon Pro Image Filters AI denoiser for the CPU and GPU Progressive Lightmapper. Currently Windows and AMD hardware only. ![description](https://unity.com/sites/default/files/2019-3-feature-radeonprodenoiser.png)
...
*   Package: `com.unity.addressables` is now a verified package ![description](https://unity.com/sites/default/files/addressables.png)
...
*   Package Manager: Enabled UI support for Git package installation in the Package Manager window. ![description](https://unity.com/sites/default/files/package_manager-_add_packages_from_git_url.png)
...
*   Profiler: Added Deep Profiler support to Mono and IL2CPP players. ![description](https://unity.com/sites/default/files/2019-3-feature-deepprofile_supportinplayers.png)
...
*   Profiler: Added managed allocation callstacks support in players. When you enable callstacks collection, GC.Alloc samples contain C# code callstack. ![description](https://unity.com/sites/default/files/2019-3-feature-managedallocationcallstacks.png)
