...
- Animation: Fixed time conversion for mismatching frame rates in Timeline Window when linked to the Animation Window.
    ...
    *First seen in 6000.6.0a3.*    <br>*Fixed in 6000.6.0a6.*
...
- Editor: Fix Play Mode toolbar button and warning icon not updating when Build Profile is added to a Play Mode Scenario configuration.
    ([UUM-142263](https://issuetracker.unity3d.com/issues/play-mode-button-doesnt-change-states-when-play-mode-scenario-setup-is-resolved-slash-broken))    <br>*Fixed in 6000.6.0a8.*
...
- Package Manager: Fixed intermittent `EPERM: operation not permitted, rename` errors on Windows during package installation.
    ([UUM-142421](https://issuetracker.unity3d.com/issues/package-installation-fails-non-deterministically-with-errors-eperm-operation-not-permitted-when-installing-packages))    <br>*Fixed in 6000.6.0a7.*

- Physics: Fixed a crash caused by disabled Rigidbody component instances keeping their internal actor alive indefinitely.
    ([UUM-143658](https://issuetracker.unity3d.com/issues/crash-on-physicscommands-physx-bodysetpose-when-entering-play-mode-in-a-specific-project))    <br>*Fixed in 6000.6.0a8.*
...
- Editor: Improved the error message for `OnAssignMaterialModel`.
    (UUM-136434)<br>
...
- 2D: Ensure Universal.2D.Runtime supports Fast Enter Play Mode with ResetStaticsOnLoad.
    (UUM-138310)<br>
    *First seen in 6000.6.0a1.*
...
- Editor: Fixed a NullReferenceException when deleting GameObjects while in an active Editor tool.
    ([UUM-139799](https://issuetracker.unity3d.com/issues/nullreferenceexception-errors-are-thrown-when-deleting-a-decal-projector-gameobject-with-decal-projector-move-tool-active-and-hierarchy-v2-enabled))<br>
    *First seen in 6000.6.0a3.*
...
- Editor: Fixed an issue where the HDRP `ColumnDrawer` did not validate argument values correctly.
    ([UUM-139572](https://issuetracker.unity3d.com/issues/creating-a-light-while-the-light-search-window-is-open-on-an-hdrp-project-throws-a-nullreferenceexception))<br>
    *First seen in 6000.6.0a3.*
...
- Editor: Fixed Cloud Build button hidden for multi-target SDK platforms.
    (UUM-138323)<br>
    *First seen in 6000.6.0a3.*
...
- Editor: Fixed WinEditor Custom UI scaling where some Utility windows slowly grow in size each time they're opened.
    (UUM-137571)<br>
    *First seen in 6000.6.0a2.*
...
- Editor: Project Auditor: Filter performance critical issues with a checkbox, instead of upgrading severities.
    (UUM-138273)<br>
    *First seen in 6000.6.0a3.*
...
- Graphics: Fixed heap-use-after-free error in graphics internals.
    (UUM-137081)<br>
    *First seen in 6000.6.0a2.*
...
- Scripting: Fixed an `InvalidCastException` when calling a C\# method that returns an enum type from C++.
    (UUM-136123)<br>
    *First seen in 6000.6.0a1.*
...
- SRP Core: Reset static variables for CoreCLR / Fast Enter Play Mode compatibility.
    (UUM-138307)<br>
    *First seen in 6000.6.0a1.*
...
- UI Toolkit: Fixed an exception being thrown when right clicking the root element of a PanelRenderer in the hierarchy.
...
- UI Toolkit: Fixed build size regression.
    (UUM-139780)<br>
    *First seen in 6000.6.0a4.*
...
- UI Toolkit: Fixed text overlay information in the UI toolkit debugger.
    (UUM-138213)<br>
    *First seen in 6000.6.0a2.*
...
- UI Toolkit: Fixed the UI Builder AssetReference variable item type dropdown appearing in the wrong place.
    ([UUM-139728](https://issuetracker.unity3d.com/issues/assetreference-variable-dropdown-is-not-aligned-with-other-variable-type-dropdowns-in-ui-builder))<br>
    *First seen in 6000.6.0a3.*
...
- URP: Fixed an issue where Screen Space Ambient Occlusion \(SSAO\) effect was misaligned and shrunk to the bottom-left corner when using Dynamic Resolution \(`ScalableBufferManager`\).
    (UUM-138246)<br>
    *First seen in 6000.6.0a1.*
...
- URP: Fixed missing material converters for SpeedTree8 and SpeedTree9 shaders.
    ([UUM-139275](https://issuetracker.unity3d.com/issues/materialupgrader-speedtree-no-upgraders-for-speedtree8-and-speedtree9-shaders))<br>
    *First seen in 6000.6.0a3.*

- URP: Fixed missing material converters for Terrain Specular and Terrain Diffuse shaders.
    ([UUM-139007](https://issuetracker.unity3d.com/issues/materialupgrader-terrainshader-no-converters-for-terrain-specular-and-terrain-diffuse-shaders))<br>
    *First seen in 6000.6.0a3.*
...
- WebGL: Fixed an issue where samplers associated with unfilterable textures were incorrectly configured in WebGPU.
    (UUM-140090)<br>
    *First seen in 6000.6.0a4.*
...
- com.unity.test-framework: [1.7.1](https://docs.unity3d.com/Packages/com.unity.test-framework@1.7//changelog/CHANGELOG.html) to [1.8.0](https://docs.unity3d.com/Packages/com.unity.test-framework@1.8//changelog/CHANGELOG.html)
...
- com.unity.ugui: [2.5.0](https://docs.unity3d.com/Packages/com.unity.ugui@2.5//changelog/CHANGELOG.html) to [2.6.0](https://docs.unity3d.com/Packages/com.unity.ugui@2.6//changelog/CHANGELOG.html)
