...
- 6000.4.0a2: Crash on EditorUserBuildSettings::GetActiveBuildTargetName when closing the Editor on a project with the I18N.dll 
    ([UUM-138910](https://issuetracker.unity3d.com/issues/crash-on-editoruserbuildsettings-getactivebuildtargetname-when-closing-the-editor-on-a-project-with-the-i18n-dot-dll))
