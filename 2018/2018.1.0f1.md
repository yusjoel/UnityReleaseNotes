...
*   Editor: Added Templates for 3D, 2D, 3D with Extras (Preview), Lightweight (Preview), Lightweight VR (Preview), and High Definition (Preview) to streamline the new user experience with Scriptable Render Pipeline features, as well as to define better starting points for graphical, player, and lighting settings.  
    ...
    ![](https://unity.com/sites/default/files/2018.1_lwrp_template_1.png "2018.1 LWRP Template")  
    ![](https://unity.com/sites/default/files/2018.1_hdrp_template_1.png "2018.1 HDRP Template")
...
![](https://unity.com/sites/default/files/2018.1_feature_packmanui.png "2018.1 Packman UI")

*   Particles: Added GPU instancing support for Particle System Mesh rendering.  
      
    ![](https://unity.com/sites/default/files/2018.1_particles_gpumeshinstancing_1.jpg "2018.1 Particles GPU Mesh Instancing")
    
*   Particles: Added support for Orbital Velocity to the **Velocity over Lifetime** module.  
      
    
    ![](https://unity.com/kr/profiles/unity3d/themes/unity/images/assets/elements/blank-1080.gif)
...
*   Editor: Redesigned the color picker window with exposure-based HDR controls.
    ...
    ![](https://unity.com/sites/default/files/2018_1_feature_color-picker_2.png "2018.1 Color Picker")
    ---------------------------------------------------------------------------------
...
*   Timeline: Introduced new modes for editing clips in the Timeline Editor.  
    ![](https://unity.com/sites/default/files/2018.1_timeline_editmodes_1.png "2018.1 Timeline Edit Modes")
