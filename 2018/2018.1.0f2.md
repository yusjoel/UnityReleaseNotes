...
*   Package Manager: Added Package Manager User Interface to allow you to manage a Project's packages and discover new packages.
    ...
    *   The right hand pane shows information about the package, and contains links to the package documentation. ![description](https://unity.com/sites/default/files/2018.1_feature_packmanui_0.jpg)
*   Particles: Added GPU instancing support for Particle System Mesh rendering. ![description](https://unity.com/sites/default/files/2018.1_particles_gpumeshinstancing.jpg)
...
*   Editor: Redesigned the color picker window with exposure-based HDR controls. ![description](https://unity.com/sites/default/files/2018_1_feature_color-picker.png)
...
*   Timeline: Introduced new modes for editing clips in the Timeline Editor. ![description](https://unity.com/sites/default/files/2018.1_timeline_editmodes.png)
