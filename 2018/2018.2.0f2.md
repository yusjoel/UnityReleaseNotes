...
*   GI: Configurable falloff for Progressive Lightmapper (legacy, linear, inverse squared, inverse squared with attenuation). ![description](https://unity.com/sites/default/files/2018_02_feature_customizablefalloff.png)"
...
*   Scripting: Added support for serialising MinMaxCurve and MinMaxGradient in scripts. ![description](https://unity.com/sites/default/files/2018_2_feature_minmaxcurve.png) ![description](https://unity.com/sites/default/files/2018_2_feature_minmaxcurve2.png)
...
*   Particles: Moved "Show Only Selected" (aka Solo Mode) option to the Scene View Overlay, from the Particle System popout Window, so it is more discoverable. ![description](https://unity.com/sites/default/files/2018_2_improvement_particle_solo_mode.png)
...
*   Graphics: Warnings now available to users when additively loading Scenes with incompatible / non-matching Lighting Settings ![description](https://unity.com/sites/default/files/2018_2_improvement_additivelightingwarnings.gif)
