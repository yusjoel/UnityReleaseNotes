...
*   Build Pipeline: Fixed crash when loading meshes from asset bundles that contain both compressed and uncompressed meshes. ([984070](https://issuetracker.unity3d.com/issues/editor-crashes-when-loading-a-mesh-asset-with-mesh-compression-from-an-assetbundle), [995368](https://unity.com/False))
...
*   UI: Fixed issue with UI and prefab positioning when disabling/re-enabling child object. ([977959](https://issuetracker.unity3d.com/issues/turning-off-a-child-object-in-canvas-applying-changes-to-prefab-then-turning-on-again-breaks-its-layout), [986372](https://unity.com/False), [988999](https://unity.com/False))
...
*   XR: Fixed crash during build when using stereo display. ([977488](https://issuetracker.unity3d.com/issues/build-crashes-when-using-any-virtual-reality-sdk), [987308](https://unity.com/False))
...
*   iOS: Fixed black screen flickering when changing orientation via script. ([953524](https://issuetracker.unity3d.com/issues/ios-when-changing-screen-orientation-via-script-black-frame-appears), [994961](https://unity.com/False))
