...
Unity 5.2 is here! It comes with the Services Window for easy SDK-free access to [Unity Ads](https://unity.com/services/ads), [Unity Analytics](https://unity.com/services/analytics), [Unity Cloud Build](https://build.cloud.unity3d.com/landing/) and [Unity Multiplayer](https://unity.com/services/multiplayer). There are three new deployment options: Project Morpheus, Windows 10, and Universal Windows Platform as well as a ton of bug fixes.
...
- 2D: Ability to rotate sprites while Sprite Packing to save atlas space ![description](https://unity.com/sites/default/files/5.2.0-relnotes-sprite-rotation.png)
...
![description](https://unity.com/sites/default/files/5.2.0-relnotes-audio-spatialization.png) ![description](https://unity.com/sites/default/files/5.2.0-relnotes-audio-spatialization-plugin.png)
...
- Graphics: Added option in player settings for configurable vertex compression. Default values: position and UV1 is uncompressed, the rest of the channels are compressed ![description](https://unity.com/sites/default/files/5.2.0-relnotes-vertex-compression.png)
...
![description](https://unity.com/sites/default/files/5.2.0-relnotes-performance-rendering-cpu.png)
...
- UI: Dropdown control. The Dropdown can be used to let the user choose a single option from a list of options. ![description](https://unity.com/sites/default/files/5.2.0-relnotes-ui-dropdown.png)
