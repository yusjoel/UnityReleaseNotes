...
*   2D: Sorting Group:
    *   Sorts a group of Renderers (for instance, a character made up of a group of Sprite Renderers) as a whole, without any interleaving of other Renderers. ![description](https://unity.com/sites/default/files/5_6_feature_nosortinggroup_0.png)![description](https://unity.com/sites/default/files/5_6_feature_withsortinggroup.png)
...
*   Editor: Exposed the following custom handle classes in UnityEditor.IMGUI.Controls: BoxBoundsHandle, CapsuleBoundsHandle, SphereBoundsHandle. ![description](https://unity.com/sites/default/files/5_6_feature_boundshandle.gif)
...
*   GI: Added Light Modes, which replace mixed mode lighting and provide flexible ways to merge baked and realtime shadows. As part of this:
    ...
    *   Added Light Explorer window. ![description](https://unity.com/sites/default/files/5_6_feature_lightmodes_01.png) ![description](https://unity.com/sites/default/files/5_6_feature_lightmodes_02.png) ![description](https://unity.com/sites/default/files/5_6_feature_lightmodes_bakedindirect_03.jpg) ![description](https://unity.com/sites/default/files/5_6_feature_lightmodes_subtractive_04.png) ![description](https://unity.com/sites/default/files/5_6_feature_lightexplorer.png)
*   GI: Added new experimental feature: Progressive Lightmapper. This is a robust lightmapper based on path tracing, with progressive updates. It provides baked lightmaps and Light Probes, presents the first output quickly, and iteratively improves it over time.
    ...
    *   Estimated time is provided in the progress bar. ![description](https://unity.com/sites/default/files/5_6_feature_progressivelightmapper_01.jpg) ![description](https://unity.com/sites/default/files/5_6_feature_progressivelightmapper_02.jpg) ![description](https://unity.com/sites/default/files/5_6_feature_progressivelightmapper_03.png) ![description](https://unity.com/sites/default/files/5_6_feature_progressivelightmapper_04.jpg) ![description](https://unity.com/sites/default/files/5_6_feature_progressivelightmapper_05.png) ![description](https://unity.com/sites/default/files/5_6_feature_progressivelightmapper_06.gif)
...
*   Graphics: Support for Procedural Instancing, where instance data is supplied via a custom source in the Shader, rather than from Material Property Blocks. ![description](https://unity.com/sites/default/files/5_6_feature_proceduralinstancing.png)
...
*   Particles: Added new Shape Module controls to support non-randomized particle emission. ![description](https://unity.com/sites/default/files/5_6_feature_particlenonrandomizedemission.gif)
*   Particles: Redesigned Burst Emission to support 8 bursts, and added burst repeat parameters. ![description](https://unity.com/sites/default/files/5_6_feature_particleburstrepeat.gif)
*   Physics: Added new CompositeCollider2D component, providing the ability to merge together BoxCollider2D & PolygonCollider2D colliders. ![description](https://unity.com/sites/default/files/5_6_feature_compositecollider2d.gif)
*   Physics: Added `Physics2D.Distance`, `Collider2D.Distance` and `Rigidbody2D.Distance` returning new `ColliderDistance2D`. ![description](https://unity.com/sites/default/files/5_6_feature_colliderdistance.gif) ![description](https://unity.com/sites/default/files/5_6_feature_collideroverlap.gif)
...
*   Physics: Enabled BoxCollider2D & EdgeCollider2D Edge Radius feature. ![description](https://unity.com/sites/default/files/5_6_feature_edgeradius.gif)
...
*   Video: Added Video Player component and Video Clip Importer Asset Importer. They replace Movie Texture and its Importer (available with a legacy control). Notes:
    ...
    *   The Android VideoPlayer cannot yet read videos from asset bundles. ![description](https://unity.com/sites/default/files/5_6_feature_videoplayer.png) ![description](https://unity.com/sites/default/files/5_6_feature_videoclip.png) ![description](https://unity.com/sites/default/files/5_6_feature_videoplayer.gif)
...
*   Particles: Gradient Editor now supports HDR colors when used in the Custom Data streams. ![description](https://unity.com/sites/default/files/5_6_improvement_particlehdrcolors.png)
*   Particles: Huge performance improvement for particle collision against 2D Colliders. ![description](https://unity.com/sites/default/files/5_6_improvement_particlecollision2d.gif)
*   Particles: Improved overlap solver for particle collision against 2D Colliders.
*   Particles: The UI for Custom Vertex Streams has been redesigned to allow greater flexibility over what data to send to the shader, and to add more control over how it is packed into the TEXCOORD channels. ![description](https://unity.com/sites/default/files/5_6_improvement_particlevertexstreams.png)
*   Particles: You can now configure Custom Data via the Inspector using a new Module, instead of exclusively via script. ![description](https://unity.com/sites/default/files/5_6_improvement_particlecustomdata.png)
