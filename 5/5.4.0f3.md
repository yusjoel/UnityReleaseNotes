...
*   GI: Added de-noising filter to baked final gather. ![description](https://unity.com/sites/default/files/5_4_feature_gi_denoise.png)
*   GI: Light Probe Proxy Volumes  
    ...
    *   Requires shader model 4+ platform (DX11/DX12 on Windows, GLCore 4.1+ on Mac/Linux, PS4, XboxOne). ![description](https://unity.com/sites/default/files/5_4_feature_lppv.jpg)
*   Graphics: GPU Instancing Support
    ...
    *   Requires shader model 4+ platform (DX11/DX12 on Windows, GLCore 4.1+ on Mac/Linux, PS4, XboxOne). ![description](https://unity.com/sites/default/files/5_4_feature_gpuinstancing.gif)
*   Graphics: Improved multithreaded rendering:
    ...
    *   In addition to multithreaded rendering, overall CPU graphics performance should be better in 5.4. ![description](https://unity.com/sites/default/files/5_4_feature_renderopt.png)
*   Graphics: Motion vector rendering support
    ...
    *   Utilized in the current beta of [Unity Cinematic Image Effects](https://bitbucket.org/Unity-Technologies/cinematic-image-effects) ![description](https://unity.com/sites/default/files/5_4_feature_motionvector1.gif)![description](https://unity.com/sites/default/files/5_4_feature_motionvector2.gif)
    *   See Keijiro Takahashi's example of vector field visualization [KinoVision](https://github.com/keijiro/KinoVision)  
        ![description](https://unity.com/sites/default/files/5_4_feature_motionvectorstill.png)
*   Graphics: Texture Array support
    ...
    *   Here they are used in the Adam demo for terrain shading: ![description](https://unity.com/sites/default/files/5_4_feature_texturearrays.png)
*   IAP: Cloud catalog  
...
*   OSX: Unity Editor supports Mac Retina displays now (mostly for improved text and icon rendering). Windows HiDPI support in development. ![description](https://unity.com/sites/default/files/5_4_feature_retina.png)
*   Particles: New Trigger Module, including:
    ...
    *   Ability to modify/kill particles that are intersecting the collision shapes.  
        Editor UI: ![description](https://unity.com/sites/default/files/5_4_feature_particletriggermodulegui2.png) Example: ![description](https://unity.com/sites/default/files/5_4_feature_particletriggers.gif)
*   Particles: Particle width, height and depth (for Mesh particles) can now be defined independently from each other. Editor UI: ![description](https://unity.com/sites/default/files/5_4_feature_particlenonuniformsizegui.png)  
    ![description](https://unity.com/sites/default/files/5_4_feature_particletriggermodulegui2_0.png) Example: ![description](https://unity.com/sites/default/files/5_4_feature_particlesnonuniformsize.gif)
...
*   VR: Optimized Single-Pass Stereo Rendering
    ...
    *   Note that some image effects or screenspace shaders might need to be updated to work with it. ![description](https://unity.com/sites/default/files/5_4_feature_renderopt.png)
...
*   GI: Ambient Occlusion now has separate sliders for direct and indirect light. The default value is Ambient Occlusion on indirect light only. ![description](https://unity.com/sites/default/files/5_4_improvement_aosliders.png)
...
*   GI: HDR color picker is now used for ambient color, instead of color plus ambient intensity. ![description](https://unity.com/sites/default/files/5_4_improvement_ambienthdr.png)
...
*   Particles: Added particle radius parameter for world collisions. Editor UI: ![description](https://unity.com/sites/default/files/5_4_change_particlecollisionradius.png)
