...
*   [\[789557\]](https://unity.com/Issue) Animation: A warning that was erroneously displayed in AnimationClip is now displayed in ModelImporter.
*   [\[788452\]](https://unity.com/Issue) Animation: Fixed a case where adding an IsActive property to a legacy animation would cause a crash when sampling.
*   [\[783143\]](https://unity.com/Issue) Animation: Fixed a crash triggered when playing an AnimatorControllerPlayable with an invalid asset.
*   [\[766978\]](https://unity.com/Issue) Animation: Fixed an issue where an assert would pop when importing animations on a model where the skinned mesh was not on the root joint.
*   [\[785852\]](https://unity.com/Issue) Animation: Fixed an issue where interrupted transitions would cause empty states to continue to output animation.
*   [\[789784\]](https://unity.com/Issue) Animation: Fixed an issue where the transition preview wouldn't reappear when valid parameters were set (after it having disappeared when invalid parameters were set).
*   [\[789586\]](https://unity.com/Issue) Animation: Fixed case of animation clip being invalidated when adding an animation event.
*   [\[796729\]](https://unity.com/Issue) Animation: Fixed case of CullingMode not getting properties applied when changed during playmode in Inspector.
*   [\[788132\]](https://unity.com/Issue) Animation: Fixed case of GetHumanPose crashing when using it with a humanoid avatar with unsupported hierarchy.
*   [\[778887\]](https://unity.com/Issue) Animation: Fixed case of playable not updating when animator controller is already set in animator.
*   [\[786827\]](https://unity.com/Issue) Animation: Fixed case of rotation values set in inspector being restricted to 0-360 degrees when recording animation.
*   [\[784470\]](https://unity.com/Issue) Animation: Fixed case of transition not evaluating when exit time is close to 1.0.
*   [\[773437\]](https://unity.com/Issue) Animation: Fixed crashes in AudioSource.GetCustomCurve.
*   [\[793808\]](https://unity.com/Issue) Animation: Fixed cut letter in the 'Dopesheet' button, in the animation window.
*   [\[789053\]](https://unity.com/Issue) Animation: Fixed issue whereby the Z position of RectTransform couldn't be animated.
...
*   [\[792560\]](https://unity.com/Issue) Editor: Fixed gfxsettings when importing from an old unitypackage.
...
*   [\[678975\]](https://unity.com/Issue) Graphics: Fixed issue whereby building a player with -nographics would cause some image effects to become disabled in the build.
*   [\[739115\]](https://unity.com/Issue) Graphics: Repeated loading of PNG/JPG images into a Texture2D no longer fails.
...
*   [\[794384\]](https://unity.com/Issue) OpenGL: Work-around for Mac Intel driver crash when trying to use tessellation shaders on a GPU that can't do it.
...
*   [\[782556\]](https://unity.com/Issue) SpeedTree: Fixed an issue where billboards didn't scale correctly when batched.
*   [\[784423\]](https://unity.com/Issue) Terrain: Fixed an issue where deleting in-use terrainData while GI is being baked for the terrain would crash the editor.
...
*   [\[733441\]](https://unity.com/Issue) Dynamic Geometry: Fixed issue where billboard particles were casting shadows that were aligned to the view, rather than to the light direction.
*   [\[759485\]](https://unity.com/Issue) Dynamic Geometry: Fixed issue where small particles could cast the wrong sized shadows.
*   [\[798293\]](https://unity.com/Issue) Dynamic Geometry: Fixed issue where Trails and Lines were being accidentally batched together.
...
*   [\[792544\]](https://unity.com/Issue) Editor: Fixed occasional crashes on DX9/DX11 when resizing editor windows.
...
*   [\[725776\]](https://unity.com/Issue) GI: Fixed case of "Error adding system: Data not available." being thrown.
...
*   [\[794551\]](https://unity.com/Issue) Graphics: Change to expose PlayerSettings.graphicsJobs editor scripting API.
*   [\[794402\]](https://unity.com/Issue) Graphics: Fixed a crash when using instanced shader on SkinnedMeshRenderer.
*   (Issue)Graphics: Fixed case of LightEvent command buffers going out of sync in heavy multithreading scenarios.
*   [\[787939\]](https://unity.com/Issue) Graphics: Fixed case of Unity crashing after adding a Graphics Raycaster component.
*   [\[798205\]](https://unity.com/Issue) Graphics: Fixed issue with calling CommandBuffer.ReleaseTemporaryRT followed by CommandBuffer.GetTemporaryRT with the same name.
*   (Issue)Graphics: Fixed performance degradation in Transform.position, rotation and localToWorldMatrix (Get).
*   [\[797773\]](https://unity.com/Issue) Graphics: Re-enabled LightEvent.AfterShadowMap command buffers for point lights.
*   [\[798012\]](https://unity.com/Issue) Image Effects: Fixed case of OnRenderImage source argument being null for image effects applied to the scene view in some cases.
...
*   [\[761024\]](https://unity.com/Issue) iOS: Fixed performance regression caused by Physics/Job system changes.
*   [\[778222\]](https://unity.com/Issue) OpenGL: Fixed occasional crash when docking editor windows in Mac Editor.
*   [\[792881\]](https://unity.com/Issue) OpenGL: Fixed possible crashes when switching graphics API in the editor.
