...
*   Graphics: Texture Array support; seeTexture2DArray class. ![description](https://unity.com/sites/default/files/5_4_feature_texturearrays.png)
...
*   GI: Added de-noising filter to baked final gather.  
    Before: ![description](https://unity.com/sites/default/files/5_4_improvement_final-gather-denoising-before.png) After: ![description](https://unity.com/sites/default/files/5_4_improvement_final-gather-denoising-after.png)
...
*   GI: HDR color picker is now used for ambient color, instead of color plus ambient intensity. ![description](https://unity.com/sites/default/files/5_4_improvement_ambientcolorhdr.png)
...
*   Graphics: Ambient Occlusion now has separate sliders for direct and indirect light. The default value is Ambient Occlusion on indirect light only. ![description](https://unity.com/sites/default/files/5_4_improvement_ambientocclusionseparatesliders.png)
