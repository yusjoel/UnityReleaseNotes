...
*   2D : 2D Placeholder Assets Creation Tools ![description](https://unity.com/sites/default/files/5.3.0-relnotes-2d-placeholder-creation-tools.png) ![description](https://unity.com/sites/default/files/5.3.0-relnotes-2d-placeholder-assets.png)
...
*   Particles: API exposed to script ![description](https://unity.com/sites/default/files/5.3.0-relnotes-particles-api-script.png)
...
*   Testing: Editor Tests Runner integration ![description](https://unity.com/sites/default/files/5.3.0-relnotes-editor-test-runner.png) Debug.Assert got new overloads and Debug.LogAssert was added
