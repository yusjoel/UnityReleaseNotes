...
*   Editor: Mem Record: Native memory performance profiling for CPU Profiler Timeline. Shows callstacks of native memory allocations. ![description](https://unity.com/sites/default/files/5_5_feature_native_mem_profiling.png)
*   Editor: New High Detail view in the CPU Profiler Timeline. Shows all profiler samples without filtering. ![description](https://unity.com/sites/default/files/5_5_feature_profiler_timeline_high_detail.png)
...
*   Graphics: Unity splash screen tools. ![description](https://unity.com/sites/default/files/5_5_feature_splashscreentools1.gif) ![description](https://unity.com/sites/default/files/5_5_feature_splashscreentools2.gif)
*   Particles: New Modules:
    ...
    *   Noise Module, for adding Curl Noise to Particle Movement ![description](https://unity.com/sites/default/files/5_5_feature_particlenoise.gif)
    *   Trails Module, for rendering ribbonized trails behind particles ![description](https://unity.com/sites/default/files/5_5_feature_particletrails.gif)
...
*   VR: Holographic Emulation ![description](https://unity.com/sites/default/files/5_5_feature_holographicemulation_0.gif)
...
*   Graphics: Added support for BC4/BC5 texture formats on PC and consoles. The new formats are available in Texture Import format override options (they are not used by default), or when creating Textures from scripts. ![description](https://unity.com/sites/default/files/5_5_improvement_bc5textureformat.png)
...
*   Particles: Added "Show Bounds" to Particle System UI. This shows the world and local AABB for the system. ![description](https://unity.com/sites/default/files/5_5_improvement_particlebounds.png)
*   Particles: Added a new Render mode to make particle billboards face the eye position. This is good for VR rendering. ![description](https://unity.com/sites/default/files/5_5_improvement_particlefacingeye.png)
*   Particles: Added a new Shape Module option to rotate particles to face their initial direction of travel. ![description](https://unity.com/sites/default/files/5_5_improvement_particlealigntodirection.png)
*   Particles: Added support for sending custom data to Particle System vertex Shaders. ![description](https://unity.com/sites/default/files/5_5_improvement_particlevertexstreams.gif)
*   Particles: Gradients now support a fixed color mode, where no blending is performed. This is useful when users want to define a simple list of possible colors to be chosen from. ![description](https://unity.com/sites/default/files/5_5_improvement_particlefixedgradient.png)
