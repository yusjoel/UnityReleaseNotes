...
*   Video: Added Video Player component and Video Clip Importer Asset Importer. They replace Movie Texture and its Importer (available with a legacy control). Note that for use on Android, Android version 6.0 or higher is recommended. ![description](https://unity.com/sites/default/files/5_6_feature_videoplayer.png) ![description](https://unity.com/sites/default/files/5_6_feature_videoclip.png) ![description](https://unity.com/sites/default/files/5_6_feature_videoplayer.gif)
