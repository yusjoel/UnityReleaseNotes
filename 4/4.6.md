...
With Unity 4.6 all Unity developers get access to polished and optimized UI tools to do far more, far faster with much less coding.

Don’t forget that, as we announced [here](http://blogs.unity3d.com/2014/11/20/apple-ios-64-bit-support-in-unity/), we plan to ship a beta preview of our iOS ARM64-bit feature based on Unity 4.6.x in January 2015.

Plus, for detailed information about the integration of bug fixes from the 4.5.5 patch releases see [here](http://blogs.unity3d.com/2014/11/24/sustained-engineering-plan-for-unity-4-5-and-4-6/).

Read on for the full list of new features and updates in Unity 4.6!
