...
The Unity 4.2.2 release brings you fixes. Read the release notes below for details.

For more information about the previous main release, see the [Unity 4.2 Release Notes](https://unity.com/unity/whats-new/unity-4.2).
